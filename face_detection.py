...
TRANSLATIONS: dict[str, dict] = {
    "en": {
        ...
        "select_prompt": "Choose a language / Choisissez une langue / Elige un idioma:\n"
                         ...
                         "  ur  اردو\n  nl  Nederlands\n"
                         "Your choice: ",
        "invalid_lang":  "Please type one of: en, fr, es, ar, pt, de, ur, nl.",
    ...
    "nl": {
        ...
        "select_prompt": "",  # only shown in English
        "invalid_lang":  "",
        "detected_n":    "{n} gezicht(en) gedetecteerd.",
        "none_detected": "Geen gezichten gedetecteerd.",
        "face_label":    "Gezicht {i} van {total}",
        "face_label_1":  "Een persoon",
        "consent_q":     "{face_label} gedetecteerd — kledingkleur lijkt {colour}. "
                         "Heeft u toestemming van deze persoon om deze foto te delen? (ja/nee): ",
        "consent_yes":   "  Begrepen — gezicht {i} gemarkeerd.",
        "consent_duration_q": "  Hoe lang is de toestemming geldig? (seconden, standaard {default}): ",
        "consent_duration_invalid": "  Voer een positief geheel aantal seconden in.",
        "consent_expired":   "  Toestemming voor gezicht {i} is al verlopen — gezicht wordt vervaagd.",
        "consent_timer_label": "{secs}s",
        "expiry_watching":   "\nToestemmingsverloop wordt bewaakt — afbeelding wordt automatisch bijgewerkt.",
        "expiry_fired":      "  [timer] Toestemming voor gezicht {i} is verlopen — gezicht vervaagd en afbeelding opnieuw opgeslagen.",
        "expiry_all_done":   "  [timer] Alle timers zijn verlopen. Definitieve afbeelding opgeslagen.",
        "badge_100":     "🏆 Perfecte Privacybadge — volledig conform!",
        "badge_80":      "✅ Veilige Makerbadge — goed gedaan!",
        "badge_50":      "⚠️ Controle nodig — sommige gezichten niet behandeld.",
        "badge_low":     "🔴 Hoog risico — nog niet veilig om te delen.",
        "style_square":  "vierkant",
        "style_oval":    "ovaal",
        "style_strong":  "sterk",
        "style_silhouette": "silhouet",
        "style_emoji":   "emoji",
        "blur_q":        "  Geen probleem. Wilt u dit gezicht in plaats daarvan vervagen? (ja/nee): ",
        "blur_no":       "  Oké — gezicht {i} ongewijzigd gelaten.",
        "blur_done":     "  Gezicht {i} vervaagd ({style}).",
        "style_prompt":  "  Vervagingsstijl [vierkant (s), ovaal (o), sterk (t), silhouet (l), emoji (e)]? ",
        "style_invalid": "  Typ vierkant, ovaal, sterk, silhouet of emoji (of de letter).",
        "invalid_yn":    "Antwoord met ja of nee.",
        "saved":         "\nUitvoer opgeslagen in: {path}",
        "summary":       "\n{total} gezicht(en) verwerkt: {consented} met toestemming, "
                         "{blurred} vervaagd ({blur_breakdown}), {skipped} ongewijzigd gelaten. "
                         "Klaar om te publiceren!",
        "ai_watermark":  "DOOR AI GEGENEREERDE INHOUD",
        "ai_label":      "⚠ Door AI gegenereerde inhoud gedetecteerd (EU AI-verordening label toegepast).",
        "ai_none":       "Geen markeringen van door AI gegenereerde inhoud gedetecteerd.",
        "scene_indoor":  "Scène: binnen.",
        "scene_outdoor": "Scène: buiten.",
        "score_line":    "Veilige inhoudsscore: {score}/100 ({risk}).",
        "score_safe":    "veilig",
        "score_medium":  "gemiddeld risico",
        "score_high":    "hoog risico",
        "pdf_title":          "Inhoudsnalevingsrapport",
        "pdf_generated":      "Gegenereerd: {now}   |   Taal: {lang}   |   Afbeelding: {name}",
        "pdf_s1_title":       "1. Afbeeldingsinformatie",
        "pdf_file":           "Bestand",
        "pdf_dimensions":     "Afmetingen",
        "pdf_scene":          "Scène",
        "pdf_ai_content":     "AI-inhoud",
        "pdf_s2_title":       "2. Overzicht gezichtsverwerking",
        "pdf_total":          "Totaal gedetecteerde gezichten",
        "pdf_consented":      "Toestemming gegeven",
        "pdf_blurred":        "Vervaagd",
        "pdf_breakdown":      "Uitsplitsing",
        "pdf_skipped":        "Ongewijzigd gelaten",
        "pdf_col_idx":        "#",
        "pdf_col_outcome":    "Resultaat",
        "pdf_col_style":      "Stijl",
        "pdf_col_colour":     "Kledingkleur",
        "pdf_col_consent":    "Toest. (s)",
        "pdf_expired":        "verlopen",
        "pdf_s3_title":       "3. Veilige inhoudsscore",
        "pdf_score_formula":  "Scoreformule: 100 x (toestemming + vervaagd) / totaal gedetecteerde gezichten.\n"
                              "100 = volledig conform. Elk gezicht zonder toestemming of vervaging verlaagt de score.",
        "pdf_s4_title":       "4. Aanbevelingen",
        "pdf_rec_skipped":    "{n} gezicht(en) zijn achtergelaten zonder toestemming of vervaging. "
                              "Controleer deze voor publicatie om schendingen van de privacy te voorkomen.",
        "pdf_rec_ai":         "Door AI gegenereerde inhoud is gedetecteerd. Volgens de EU AI-verordening "
                              "moet deze inhoud duidelijk worden gelabeld als door AI gegenereerd in alle publicaties.",
        "pdf_rec_score":      "De veilige inhoudsscore is lager dan 80. Verkrijg expliciete toestemming of "
                              "pas privacyvervaging toe op alle onverwerkte gezichten voordat u deelt.",
        "pdf_rec_ok":         "Alle gezichten hebben toestemming gekregen of zijn correct geanonimiseerd. "
                              "Deze afbeelding lijkt geschikt om te delen.",
        "pdf_footer":         "Compliact  |  Rapport gegenereerd {now}  |  Uitvoer: {name}",
        "save_error":          "  [fout] Kon afbeelding niet opslaan naar: {path}",
        "load_error":          "Fout: kon '{path}' niet laden. Het bestand kan beschadigd zijn of een "
                               "niet-ondersteund formaat hebben. Ondersteunde formaten: JPG, PNG, BMP, WEBP, TIFF.",
        "outcome_consented":   "toestemming",
        "outcome_blurred":     "vervaagd",
        "outcome_skipped":     "overgeslagen",
        "yes_answers":   ("ja", "j", "yes", "y"),
        "no_answers":    ("nee", "n", "no"),
        "colours": {
            "red": "rood",        "orange": "oranje",      "yellow": "geel",
            "green": "groen",     "teal": "blauwgroen",    "blue": "blauw",
            "navy": "marineblauw","purple": "paars",        "pink": "roze",
            "white": "wit",       "light grey": "lichtgrijs",
            "grey": "grijs",      "dark grey": "donkergrijs",
            "black": "zwart",     "brown": "bruin",
            "rust": "roestkleur", "terracotta": "terracotta", "beige": "beige",
        },
    },
}
